...
bool Application::Init(int w, int h)
{
	...
	// ウィンドウ作成
	//===================================================================
	if (m_window.Create(w, h, "怪盗とふしぎな城", "Window") == false) {
	...
	// imgui初期設定
	//===================================================================
	//imgui導入で追加_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
...
void Application::Execute()
{
	...
	while (1)
	{
		...
		//FPS表示（タイトルバー）
		std::string titlBar = "怪盗とふしぎな城  [FPS]:" + std::to_string(m_fps);
